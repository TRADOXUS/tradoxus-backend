...
describe("Course Routes", () => {
  ...
  beforeEach(() => {
    ...
    mockCourseController.create = jest.fn().mockImplementation(function (
    ...
    mockCourseController.findAll = jest.fn().mockImplementation(function (
      this: CourseController,
      req,
      res,
    ) {
    ...
    mockCourseController.findOne = jest.fn().mockImplementation(function (
      this: CourseController,
      req,
      res,
    ) {
    ...
    mockCourseController.update = jest.fn().mockImplementation(function (
      this: CourseController,
      req,
      res,
    ) {
    ...
    mockCourseController.delete = jest.fn().mockImplementation(function (
      this: CourseController,
      req,
      res,
    ) {
    ...
    mockCourseController.getPublishedCourses = jest
      .fn()
      .mockImplementation(function (this: CourseController, req, res) {
    ...
    mockCourseController.togglePublish = jest.fn().mockImplementation(function (
      this: CourseController,
      req,
      res,
    ) {
    ...
    (LessonController as jest.Mock).mockImplementation(
      () => new LessonController(),
    );
    (CapsuleController as jest.Mock).mockImplementation(
      () => new CapsuleController(),
    );
  ...
  describe("DELETE /api/courses/:id", () => {
    it("should delete a course", async () => {
      const response = await request(app).delete("/api/courses/1").expect(200);

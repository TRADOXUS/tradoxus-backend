...
describe("Capsule Routes", () => {
  ...
  beforeEach(() => {
    ...
    mockCapsuleController =
      new CapsuleController() as jest.Mocked<CapsuleController>;

    // Mock all controller methods
    mockCapsuleController.create = jest.fn().mockImplementation(function (
      this: CapsuleController,
      req,
      res,
    ) {
      res.json({ id: 1, ...req.body });
    });
    mockCapsuleController.findAll = jest.fn().mockImplementation(function (
      this: CapsuleController,
      req,
      res,
    ) {
    ...
    mockCapsuleController.findOne = jest.fn().mockImplementation(function (
      this: CapsuleController,
      req,
      res,
    ) {
    ...
    mockCapsuleController.update = jest.fn().mockImplementation(function (
      this: CapsuleController,
      req,
      res,
    ) {
    ...
    mockCapsuleController.delete = jest.fn().mockImplementation(function (
      this: CapsuleController,
      req,
      res,
    ) {
    ...
    mockCapsuleController.createInLesson = jest
      .fn()
      .mockImplementation(function (this: CapsuleController, req, res) {
        res.json({ id: 1, lessonId: req.params.lessonId, ...req.body });
      });
    mockCapsuleController.getCapsulesByLesson = jest
      .fn()
      .mockImplementation(function (this: CapsuleController, req, res) {
        res.json([
          { id: 1, lessonId: req.params.lessonId, title: "Capsule 1" },
        ]);
      });
    mockCapsuleController.getCapsulesByType = jest
      .fn()
      .mockImplementation(function (this: CapsuleController, req, res) {
        res.json([{ id: 1, type: req.params.type, title: "Capsule 1" }]);
      });
    mockCapsuleController.updateContent = jest
      .fn()
      .mockImplementation(function (this: CapsuleController, req, res) {
        res.json({ id: 1, content: req.body.content });
      });
    mockCapsuleController.reorderCapsules = jest
      .fn()
      .mockImplementation(function (this: CapsuleController, req, res) {
        res.json({ success: true });
      });
    ...
    (CapsuleController as jest.Mock).mockImplementation(
      () => mockCapsuleController,
    );
    ...
    router.post(
      "/",
      validateRequest(CreateCapsuleDto),
      asyncHandler((req, res) => mockCapsuleController.create(req, res)),
    );
    router.get(
      "/",
      asyncHandler((req, res) => mockCapsuleController.findAll(req, res)),
    );
    router.get(
      "/:id",
      asyncHandler((req, res) => mockCapsuleController.findOne(req, res)),
    );
    router.put(
      "/:id",
      validateRequest(UpdateCapsuleDto),
      asyncHandler((req, res) => mockCapsuleController.update(req, res)),
    );
    router.delete(
      "/:id",
      asyncHandler((req, res) => mockCapsuleController.delete(req, res)),
    );
    ...
    router.post(
      ...
      asyncHandler((req, res) =>
        mockCapsuleController.createInLesson(req, res),
      ),
    );
    router.get(
      "/lessons/:lessonId",
      asyncHandler((req, res) =>
        mockCapsuleController.getCapsulesByLesson(req, res),
      ),
    );
    router.put(
      "/lessons/:lessonId/reorder",
      asyncHandler((req, res) =>
        mockCapsuleController.reorderCapsules(req, res),
      ),
    );
    router.put(
      "/:id/content",
      asyncHandler((req, res) => mockCapsuleController.updateContent(req, res)),
    );
    router.get(
      "/type/:type",
      asyncHandler((req, res) =>
        mockCapsuleController.getCapsulesByType(req, res),
      ),
    );
  ...
  describe("GET /api/capsules", () => {
    it("should get all capsules", async () => {
      const response = await request(app).get("/api/capsules").expect(200);
  ...
  describe("GET /api/capsules/:id", () => {
    it("should get a capsule by id", async () => {
      const response = await request(app).get("/api/capsules/1").expect(200);
  ...
  describe("DELETE /api/capsules/:id", () => {
    it("should delete a capsule", async () => {
      const response = await request(app).delete("/api/capsules/1").expect(200);

...
describe('Module Routes', () => {
  ...
  beforeEach(() => {
    ...
    mockModuleController = new ModuleController() as jest.Mocked<ModuleController>;
    
    // Mock all controller methods
    mockModuleController.create = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json({ id: 1, ...req.body });
    });
    mockModuleController.findAll = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json([{ id: 1, title: 'Module 1' }, { id: 2, title: 'Module 2' }]);
    });
    mockModuleController.findOne = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json({ id: 1, title: 'Test Module' });
    });
    mockModuleController.update = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json({ id: 1, ...req.body });
    });
    mockModuleController.delete = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json({ success: true });
    });
    mockModuleController.createInCourse = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json({ id: 1, courseId: req.params.courseId, ...req.body });
    });
    mockModuleController.getModulesByCourse = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json([{ id: 1, courseId: req.params.courseId, title: 'Module 1' }]);
    });
    mockModuleController.getModuleWithLessons = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json({ id: 1, title: 'Test Module', lessons: [] });
    });
    mockModuleController.reorderModules = jest.fn().mockImplementation(function(this: ModuleController, req, res) {
      res.json({ success: true });
    });
    ...
    (ModuleController as jest.Mock).mockImplementation(() => mockModuleController);
    ...
    router.post('/courses/:courseId', validateRequest(CreateModuleDto), asyncHandler((req, res) => mockModuleController.createInCourse(req, res)));
    router.get('/courses/:courseId', asyncHandler((req, res) => mockModuleController.getModulesByCourse(req, res)));
    router.put('/courses/:courseId/reorder', asyncHandler((req, res) => mockModuleController.reorderModules(req, res)));
    router.get('/:id/lessons', asyncHandler((req, res) => mockModuleController.getModuleWithLessons(req, res)));

    // Generic CRUD routes
    router.post('/', validateRequest(CreateModuleDto), asyncHandler((req, res) => mockModuleController.create(req, res)));
    router.get('/', asyncHandler((req, res) => mockModuleController.findAll(req, res)));
    router.get('/:id', asyncHandler((req, res) => mockModuleController.findOne(req, res)));
    router.put('/:id', validateRequest(UpdateModuleDto), asyncHandler((req, res) => mockModuleController.update(req, res)));
    router.delete('/:id', asyncHandler((req, res) => mockModuleController.delete(req, res)));

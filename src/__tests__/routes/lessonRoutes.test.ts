...
describe("Lesson Routes", () => {
  ...
  beforeEach(() => {
    ...
    mockLessonController =
      new LessonController() as jest.Mocked<LessonController>;

    // Mock all controller methods
    mockLessonController.create = jest.fn().mockImplementation(function (
    ...
    mockLessonController.findAll = jest.fn().mockImplementation(function (
      this: LessonController,
      req,
      res,
    ) {
    ...
    mockLessonController.findOne = jest.fn().mockImplementation(function (
      this: LessonController,
      req,
      res,
    ) {
    ...
    mockLessonController.update = jest.fn().mockImplementation(function (
      this: LessonController,
      req,
      res,
    ) {
    ...
    mockLessonController.delete = jest.fn().mockImplementation(function (
      this: LessonController,
      req,
      res,
    ) {
    ...
    mockLessonController.createInModule = jest
      .fn()
      .mockImplementation(function (this: LessonController, req, res) {
        res.json({ id: 1, ...req.body });
      });
    mockLessonController.getLessonsByModule = jest
      .fn()
      .mockImplementation(function (this: LessonController, req, res) {
        res.json({
          items: [
    ...
    mockLessonController.reorderLessons = jest
      .fn()
      .mockImplementation(function (this: LessonController, req, res) {
        res.json([
          { id: 1, order: 1 },
    ...
    mockLessonController.getLessonWithCapsules = jest
      .fn()
      .mockImplementation(function (this: LessonController, req, res) {
        res.json({
          id: 1,
    ...
    mockLessonController.updatePrerequisites = jest
      .fn()
      .mockImplementation(function (this: LessonController, req, res) {
  ...
  describe("POST /api/lessons", () => {
    ...
    it("should validate lesson data", async () => {
      ...
      await request(app).post("/api/lessons").send(invalidData).expect(400);
    });
  });
  ...
  describe("PUT /api/lessons/:id", () => {
    ...
    it("should validate update data", async () => {
      ...
      await request(app).put("/api/lessons/1").send(invalidData).expect(400);
    });
  });

  describe("DELETE /api/lessons/:id", () => {
    it("should delete a lesson", async () => {
      const response = await request(app).delete("/api/lessons/1").expect(200);

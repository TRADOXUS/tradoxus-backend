...
describe("PortfolioService", () => {
  ...
  beforeEach(() => {
    ...
    portfolioService = new PortfolioService(mockTransactionRepo, mockBalanceRepo, mockUserRepo)
  })
  ...
  describe("createTransaction", () => {
    ...
    it("should create a transaction successfully", async () => {
      ...
      const result = await portfolioService.createTransaction("user-1", createTransactionDto)
    ...
    it("should throw error if user not found", async () => {
      ...
      await expect(portfolioService.createTransaction("user-1", createTransactionDto)).rejects.toThrow(

        ...
        const serializedCapsule = {
          ...
          lesson: {
            ...
            module: {
              ...
              createdAt: new Date(
                capsule.lesson.module.createdAt,
              ).toISOString(),
              updatedAt: new Date(
                capsule.lesson.module.updatedAt,
              ).toISOString(),
              course: {
                ...capsule.lesson.module.course,
                createdAt: new Date(
                  capsule.lesson.module.course.createdAt,
                ).toISOString(),
                updatedAt: new Date(
                  capsule.lesson.module.course.updatedAt,
                ).toISOString(),
              },
            },
          },
...
describe("Capsule Controller Tests", () => {
  ...
  describe("GET /api/capsules/:id", () => {
    ...
    it("should return 404 for non-existent capsule", async () => {
      const response = await request(app).get("/api/capsules/999").expect(404);
  ...
  describe("DELETE /api/capsules/:id", () => {
    it("should delete a capsule", async () => {
      await request(app).delete("/api/capsules/1").expect(204);
    });

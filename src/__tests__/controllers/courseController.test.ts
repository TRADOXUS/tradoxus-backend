...
describe('Course Controller Tests', () => {
    ...
    beforeEach(() => {
        ...
        const router = Router();
        router.post('/courses', asyncHandler((req, res) => courseController.create(req, res)));
        router.get('/courses', asyncHandler((req, res) => courseController.findAll(req, res)));
        router.get('/courses/published', asyncHandler((req, res) => courseController.getPublishedCourses(req, res)));
        router.get('/courses/:id', asyncHandler((req, res) => courseController.findOne(req, res)));
        router.put('/courses/:id', asyncHandler((req, res) => courseController.update(req, res)));
        router.delete('/courses/:id', asyncHandler((req, res) => courseController.delete(req, res)));
        router.get('/courses/:id/modules', asyncHandler((req, res) => courseController.getCourseWithModules(req, res)));
    ...
    describe('GET /api/courses/published', () => {
        it('should get published courses with pagination', async () => {
            ...
            courseService.getPublishedCourses.mockImplementation(async () => mockResponse);

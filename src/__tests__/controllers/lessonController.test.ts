...
describe('Lesson Controller Tests', () => {
    ...
    describe('PUT /api/lessons/:id', () => {
        it('should update a lesson', async () => {
            ...
            expect(new Date(response.body.createdAt).toISOString()).toBe(response.body.createdAt);
            expect(new Date(response.body.updatedAt).toISOString()).toBe(response.body.updatedAt);
            expect(new Date(response.body.module.createdAt).toISOString()).toBe(response.body.module.createdAt);
            expect(new Date(response.body.module.updatedAt).toISOString()).toBe(response.body.module.updatedAt);
        });

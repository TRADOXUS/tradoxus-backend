...
jest.mock('../../middleware/errorHandler', () => {
    ...
    return {
        ...
        AppError: jest.fn().mockImplementation((statusCode: number, message: string) => {
...
describe('Admin Auth Middleware (requireAdmin)', () => {
    ...
    it('should call next with a 403 AppError if req.user is missing', () => {
        ...
        expect(AppError).toHaveBeenCalledWith(403, 'Forbidden: Administrator privileges required.');
    });

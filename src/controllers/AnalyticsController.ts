...
export class AnalyticsController {
  ...
  getUserStatistics(req: Request, res: Response, next: NextFunction): void {
    ...
    this.analyticsService.getUserStatistics(userId)
  ...
  getLessonAnalytics(req: Request, res: Response, next: NextFunction): void {
    ...
    this.analyticsService.getLessonAnalytics(lessonId)
      .then(analytics => res.json(analytics))
      .catch(next);
  }

  getCourseCompletionRate(req: Request, res: Response, next: NextFunction): void {
    const { courseId } = req.params;
    this.analyticsService.getCourseCompletionRate(courseId)
  ...
  bulkUpdateProgress(req: Request, res: Response, next: NextFunction): void {
    ...
    this.analyticsService.bulkUpdateProgress(dto.updates)
  ...
  getBulkStatus(req: Request, res: Response, next: NextFunction): void {
    ...
    this.analyticsService.getBulkStatus(dto.userIds, dto.lessonIds)

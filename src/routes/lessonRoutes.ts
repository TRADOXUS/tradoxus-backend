...
export const createLessonRouter = (lessonController: LessonController) => {
  ...
  router.post(
    "/",
    validateRequest(CreateLessonDto),
    asyncHandler((req, res) => lessonController.create(req, res)),
  );
  router.get(
    "/",
    asyncHandler((req, res) => lessonController.findAll(req, res)),
  );
  router.get(
    "/:id",
    asyncHandler((req, res) => lessonController.findOne(req, res)),
  );
  router.put(
    "/:id",
    validateRequest(UpdateLessonDto),
  ...
  router.get(
    ...
    asyncHandler((req, res) =>
      lessonController.getLessonWithCapsules(req, res),
    ),
  );
  router.patch(
    "/:id/prerequisites",

...
router.post(
  "/lessons/:lessonId",
  capsuleController.createInLesson.bind(capsuleController),
);
router.get(
  "/lessons/:lessonId",
  capsuleController.getCapsulesByLesson.bind(capsuleController),
);
router.put(
  "/lessons/:lessonId/reorder",
  capsuleController.reorderCapsules.bind(capsuleController),
);
router.put(
  "/:id/content",
  capsuleController.updateContent.bind(capsuleController),
);
router.get(
  "/type/:type",
  capsuleController.getCapsulesByType.bind(capsuleController),
);

...
router.post(
  "/courses/:courseId",
  moduleController.createInCourse.bind(moduleController),
);
router.get(
  "/courses/:courseId",
...
router.put(
  ...
  moduleController.reorderModules.bind(moduleController),
);
router.get(
  "/:id/lessons",
  moduleController.getModuleWithLessons.bind(moduleController),
);
